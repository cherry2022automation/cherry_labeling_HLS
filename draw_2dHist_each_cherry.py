...
output_dir = "C:\\Users\\cherr\\Desktop\\data\\result\\hist2d\\one_cherry\\"
...
for num in data_num:
    ...
    plt.savefig("{}{}_{}.png".format(output_dir, cherry_01.grade, cherry_01.num))